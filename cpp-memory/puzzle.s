	...
	.p2align	3               ## -- Begin function _Z14CreateUnitCubev
LCPI0_0:
	.quad	4624633867356078080     ## double 15
	.section	__TEXT,__text,regular,pure_instructions
	.globl	__Z14CreateUnitCubev
	.p2align	4, 0x90
__Z14CreateUnitCubev:                   ## @_Z14CreateUnitCubev
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	...
	leaq	-8(%rbp), %rdi
	callq	__ZN4uiuc4Cube9setLengthEd
	leaq	-8(%rbp), %rax
	addq	$16, %rsp
	popq	%rbp
	retq
...
## %bb.0:
	...
	subq	$64, %rsp
	movl	$0, -4(%rbp)
	callq	__Z14CreateUnitCubev
	movq	%rax, -16(%rbp)
	callq	__Z17someOtherFunctionv
	movq	-16(%rbp), %rdi
	movsd	%xmm0, -40(%rbp)        ## 8-byte Spill
	callq	__ZN4uiuc4Cube14getSurfaceAreaEv
	...
	callq	__ZN4uiuc4Cube9getVolumeEv
	movq	__ZNSt3__14coutE@GOTPCREL(%rip), %rdi
	movsd	%xmm0, -32(%rbp)
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z17someOtherFunctionv ## -- Begin function _Z17someOtherFunctionv
	.p2align	4, 0x90
__Z17someOtherFunctionv:                ## @_Z17someOtherFunctionv
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
